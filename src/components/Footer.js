    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <div className="md:flex md:items-center md:justify-between mt-0">
          <div className='mt-4 text-gray-500 '>
            ...
            <p>Endereço: R. Stelmar Jose da Silva Junior, 44</p>
          </div>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400"> Todos Os Direitos Reservados 2023 - 
        <a href="https://tanitsolutions.com/" className="hover:underline"> © Tanit Solution™</a></span>
    </div>
  </footer>
  );
};
