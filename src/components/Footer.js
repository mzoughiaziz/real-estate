    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between place-content-center pt-2">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                  <Link className='mr-4 hover:text-orangers md:mr-6' to='/'>
                    Home
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link className='mr-4 hover:text-orangers md:mr-6' to='/sobrenos'>
                    Sobre nós
                  </Link>
                </li>
                <li>
                  <Link className='hover:text-orangers' to='/contato'>
                    Contato
                  </Link>
                </li>
            </ul>
        ...
        <div className="md:flex md:items-center md:justify-between mt-0">
          <div className='my-4 text-gray-500 '>
            <p>E-mail: robertosilveira.co@gmail.com</p>
            <p>Telefone: +55 (34) 9860-7766</p>
            {/* <p>Endereço: Rua Stelmar José da Silva Junior, Loteamento Cândida Borges</p> */}
          </div>
          <div className="flex flex-col items-stretch">
            <a href='https://www.facebook.com/robertosilveira.co' target='_blank' className='pt-2 flex flex-row'>
              <svg
              ...
              <span className="block text-sm text-gray-500 dark:text-gray-400 px-2">@robertosilveira.co</span>
            </a>

            <a href='https://www.instagram.com/robertosilveira.co/' target='_blank' className='pt-2 flex flex-row'>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="#f16e1d"
