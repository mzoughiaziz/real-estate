      ...
      <section className='h-full max-h-[640px] mb-8 xl:mb-24'>
        <div className='flex flex-col lg:flex-row'>
            ...
            <div className='max-w-[580px] mb-8'>
              ...
              <p>Venha conhecer nossa metodologia inovadora e descubra como podemos transformar sua visão em um lar excepcional para você e sua família.</p>
            </div>
            </div>
